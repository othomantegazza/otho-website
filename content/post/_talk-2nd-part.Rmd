...
In the last decade, the R community has produced outstanding material to teach newcomers how to analyze data from beginners to professional level, it has shared those documents openly and has created a welcoming and encouraging community. Briefly, it did only not make R free for everybody to use and modify, and told to everybody we did, now learn it yourself. It went an extra step. it produced courses and books, that are as open as open source is. It wrote those books following standards of clarity and simplicity. It provided tools for everybody to learn to analyze data at best, and to communicate at best. Indeed it provided tools for everybody to communicate their knowledge freely as they do. And last but not least, they created an inclusive code of conduit, an effort to let everybody feel welcome, safe and encouraged to contribute.
