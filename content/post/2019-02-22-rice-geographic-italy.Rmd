...
Rice production by municipality must be downloaded manually from their database, afterwards, the data can be aggregated with this script and served to the usual leaflet app. 
