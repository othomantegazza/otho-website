...
For example, this is every area dedicated to agriculture/farming in Gaggiano, a small town south west of Milan. (The image below is a screeshot of a leaflet app, [here you'll find the code to download the data and launch the interactive app](https://github.com/othomantegazza/lorice/blob/master/gaggiano.R).)
...
I downloaded this dataset and summarized the area of land dedicated to rice production at the level of "municipality" (in Italian: "Comuni"), [here you can find the script for those steps](https://github.com/othomantegazza/lorice).
